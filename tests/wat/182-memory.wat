    ...
    (if (i32.gt_s (get_local $size) (i32.mul (i32.const 64) (global.get $__mm_min)))
      (then
        ...
        (if (i32.gt_s (get_local $need) (get_local $n))
          (then
            (unreachable)))
        (set_local $required (i32.add (i32.div_s (i32.add (i32.add (i32.const 1305) (global.get $__mm_extra_offset)) (i32.mul (i32.add (global.get $__mm_inuse) (get_local $need)) (get_local $unit))) (i32.const 64000)) (i32.const 1)))
        ...
        (block $@block_1_3_break
          ...
          (loop $@block_1_3_continue
            (br_if $@block_1_3_break (i32.ge_s (get_local $i) (get_local $need)))
        ...
        (if (i32.lt_s (get_local $idx) (i32.const 0))
          (then
            ...
            (if (i32.eq (get_local $idx) (global.get $__mm_inuse))
              (then
                (set_local $required (i32.add (i32.div_s (i32.add (i32.add (i32.const 1305) (global.get $__mm_extra_offset)) (i32.mul (i32.add (global.get $__mm_inuse) (i32.const 1)) (get_local $unit))) (i32.const 64000)) (i32.const 1)))
                (if (i32.gt_s (get_local $required) (memory.size))
                  (then
                    (drop (memory.grow (i32.sub (get_local $required) (memory.size))))))
