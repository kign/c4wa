(module
  ...
  (data (i32.const 1024) "ERROR: List is already empty\5Cn\00, \00%d\00<empty list>\00\5Cn\00")
  (func $new_node (result i32)
    (local $node i32)
    (set_local $node (i32.add (i32.mul (global.get $node_idx) (i32.const 8)) (i32.const 2048)))
      ...
      (loop $@block_1_continue
        ...
        (if (i32.gt_s (get_local $i) (i32.const 0))
          (then
            ...
            (global.set $@stack (i32.sub (global.get $@stack) (i32.const 0)))
            (call $printf (global.get $@stack) (i32.const 1))))
        (i64.store (global.get $@stack) (i64.const 1058))
