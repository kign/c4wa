(module
  ...
  (func $new_node (result i32)
    ...
    (i32.store align=4 (get_local $node) (i32.const 0))
    (get_local $node))
  (func $init_linked_list (param $list i32)
    (i32.store align=4 (get_local $list) (i32.const 0))
    (i32.store align=4 (i32.add (get_local $list) (i32.const 4)) (i32.const 0)))
  (func $pushTail (param $list i32) (param $val i32)
    (if (i32.eqz (i32.load align=4 (get_local $list)))
      (then
        (i32.store align=4 (get_local $list) (call $new_node))
        (i32.store align=4 (i32.add (get_local $list) (i32.const 4)) (i32.load align=4 (get_local $list))))
      (else
        (i32.store align=4 (i32.load align=4 (i32.add (get_local $list) (i32.const 4))) (call $new_node))
        (i32.store align=4 (i32.add (get_local $list) (i32.const 4)) (i32.load align=4 (i32.load align=4 (i32.add (get_local $list) (i32.const 4)))))))
    (i32.store align=4 (i32.add (i32.load align=4 (i32.add (get_local $list) (i32.const 4))) (i32.const 4)) (get_local $val)))
  (func $pushHead (param $list i32) (param $val i32)
    ...
    (if (i32.eqz (i32.load align=4 (get_local $list)))
      ...
      (else
        ...
        (i32.store align=4 (get_local $head) (i32.load align=4 (get_local $list)))
        (i32.store align=4 (get_local $list) (get_local $head))))
    (i32.store align=4 (i32.add (i32.load align=4 (get_local $list)) (i32.const 4)) (get_local $val)))
  (func $popTail (param $list i32) (result i32)
    (local $@stack_entry i32)
    (local $res i32)
    (local $v i32)
    (set_local $@stack_entry (global.get $@stack))
    (set_local $res (select (i32.load align=4 (i32.add (i32.load align=4 (i32.add (get_local $list) (i32.const 4))) (i32.const 4))) (i32.const 0) (i32.load align=4 (i32.add (get_local $list) (i32.const 4)))))
    (if (if (result i32) (i32.eqz (i32.load align=4 (i32.add (get_local $list) (i32.const 4)))) (then (i32.const 0)) (else (i32.ne (i32.eq (i32.load align=4 (i32.add (get_local $list) (i32.const 4))) (i32.load align=4 (get_local $list))) (i32.const 0))))
      (then
        (i32.store align=4 (get_local $list) (i32.const 0))
        (i32.store align=4 (i32.add (get_local $list) (i32.const 4)) (i32.const 0)))
      (else
        (if (i32.load align=4 (i32.add (get_local $list) (i32.const 4)))
          (then
            (block $@block_2_1_break
              (set_local $v (i32.load align=4 (get_local $list)))
              (loop $@block_2_1_continue
                (br_if $@block_2_1_break (i32.eq (i32.load align=4 (get_local $v)) (i32.load align=4 (i32.add (get_local $list) (i32.const 4)))))
                (set_local $v (i32.load align=4 (get_local $v)))
                (br $@block_2_1_continue)))
            (i32.store align=4 (get_local $v) (i32.const 0))
            (i32.store align=4 (i32.add (get_local $list) (i32.const 4)) (get_local $v)))
          (else
  ...
  (func $print_list (param $list i32)
    ...
    (block $@block_1_break
      ...
      (loop $@block_1_continue
        ...
        (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.load align=4 (i32.add (get_local $v) (i32.const 4)))))
