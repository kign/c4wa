(module
  ...
  (func $main (export "main") (result i32)
    ...
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (get_local $hello)))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (call $strlen (get_local $hello))))
    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
    (call $printf (i32.const 1031) (global.get $@stack))
    (loop $@block_1_continue
      (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.load8_s align=1 (get_local $hello))))
      (call $printf (i32.const 1071) (global.get $@stack))
      (set_local $hello (i32.add (get_local $hello) (i32.const 1)))
      (if (i32.ne (i32.load8_s align=1 (get_local $hello)) (i32.const 0))
        (then
          (call $printf (i32.const 1076) (global.get $@stack))))
      (br_if $@block_1_continue (i32.ne (i32.load8_s align=1 (get_local $hello)) (i32.const 0))))
