(module
  ...
  (func $strlen (param $str i32) (result i32)
    ...
    (loop $@block_1_continue
      ...
      (br_if $@block_1_continue (i32.ne (i32.load8_u (get_local $str)) (i32.const 0))))
    (return (get_local $n)))
  (func $main (export "main") (result i32)
    ...
    (i64.store (i32.const 0) (i64.extend_i32_s (i32.const 1031)))
    ...
    (loop $@block_1_continue
      (i64.store (i32.const 24) (i64.extend_i32_s (i32.const 1071)))
      (i64.store (i32.const 32) (i64.extend_i32_s (i32.load8_u (get_local $hello))))
      (call $printf (i32.const 24) (i32.const 2))
      (set_local $hello (i32.add (get_local $hello) (i32.const 1)))
      (if (i32.ne (i32.load8_u (get_local $hello)) (i32.const 0))
        (then
          (i64.store (i32.const 40) (i64.extend_i32_s (i32.const 1076)))
          (call $printf (i32.const 40) (i32.const 1))))
      (br_if $@block_1_continue (i32.ne (i32.load8_u (get_local $hello)) (i32.const 0))))
    (i64.store (i32.const 0) (i64.extend_i32_s (i32.const 1079)))
