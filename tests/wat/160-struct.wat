(module
  ...
  (func $main (export "main") (result i32)
    ...
    (f32.store (i32.add (get_local $A) (i32.const 1)) (f32.demote_f64 (f64.const 1.0)))
    (f32.store (i32.add (get_local $A) (i32.const 5)) (f32.demote_f64 (f64.const -2.0)))
    (f32.store (i32.add (get_local $A) (i32.const 9)) (f32.demote_f64 (f64.const 3.0)))
    (f32.store (i32.add (get_local $B) (i32.const 1)) (f32.demote_f64 (f64.const 4.0)))
    (f32.store (i32.add (get_local $B) (i32.const 5)) (f32.demote_f64 (f64.const 5.0)))
    (f32.store (i32.add (get_local $B) (i32.const 9)) (f32.demote_f64 (f64.const -6.0)))
    ...
    (i64.store (i32.const 0) (i64.extend_i32_s (i32.const 1047)))
    ...
    (call $printf (i32.const 0) (i32.const 4))
    (i64.store (i32.const 0) (i64.extend_i32_s (i32.const 1070)))
