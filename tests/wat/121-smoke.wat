(module
  ...
  (data (i32.const 1024) "x = %d, left = %d, right = %d\5Cn\00x = %ld, left = %d, right = %d\5Cn\00%d, %d, %d, %d\5Cn\00[signed:32] v = %d, w = %d, min = %d, max = %d\5Cn\00[unsigned:32] v = %u, w = %u, min = %u, max = %u\5Cn\00[signed:64] r = %ld, s = %ld, min = %ld, max = %ld\5Cn\00[unsigned:64] r = %lu, s = %lu, min = %lu, max = %lu\5Cn\00")
  ...
  (func $test_long (param $x i64)
    (local $@stack_entry i32)
    (set_local $@stack_entry (global.get $@stack))
    (i64.store (global.get $@stack) (i64.const 1056))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (get_local $x))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (i64.clz (get_local $x)))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (i64.ctz (get_local $x)))
    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 24)))
    (call $printf (global.get $@stack) (i32.const 4))
    (global.set $@stack (get_local $@stack_entry)))
  (func $main (export "main") (result i32)
    ...
    (i64.store (global.get $@stack) (i64.const 1089))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (i64.clz (get_local $x)))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (i64.ctz (get_local $x)))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (i64.clz (get_local $z)))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (i64.ctz (get_local $z)))
    ...
    (i64.store (global.get $@stack) (i64.const 1206))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    ...
    (i64.store (global.get $@stack) (i64.const 1259))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
