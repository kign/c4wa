(module
  ...
  (func $test_int (param $x i32)
    ...
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.clz (get_local $x))))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.ctz (get_local $x))))
  ...
  (func $test_long (param $x i64)
    (local $@stack_entry i32)
    (set_local $@stack_entry (global.get $@stack))
    (i64.store align=8 (global.get $@stack) (get_local $x))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.wrap_i64 (i64.clz (get_local $x)))))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.wrap_i64 (i64.ctz (get_local $x)))))
    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 16)))
  ...
  (func $main (export "main") (result i32)
    ...
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.wrap_i64 (i64.ctz (get_local $x)))))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.wrap_i64 (i64.clz (get_local $z)))))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.wrap_i64 (i64.ctz (get_local $z)))))
    ...
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (get_local $w)))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (call $__min_32s (get_local $v) (get_local $w))))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (call $__max_32s (get_local $v) (get_local $w))))
    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 24)))
    (call $printf (i32.const 1103) (global.get $@stack))
    (set_local $uv (i32.const 1073741824))
    (set_local $uw (i32.const -2147483648))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_u (get_local $uv)))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_u (get_local $uw)))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_u (call $__min_32u (get_local $uv) (get_local $uw))))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_u (call $__max_32u (get_local $uv) (get_local $uw))))
    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 24)))
    ...
    (i64.store align=8 (global.get $@stack) (get_local $r))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (get_local $s))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (call $__min_64s (get_local $r) (get_local $s)))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (call $__max_64s (get_local $r) (get_local $s)))
    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 24)))
    ...
    (i64.store align=8 (global.get $@stack) (get_local $ur))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (get_local $us))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (call $__min_64u (get_local $ur) (get_local $us)))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (call $__max_64u (get_local $ur) (get_local $us)))
    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 24)))
