(module
  ...
  (func $allocate (param $id i32) (result i32)
    ...
    (i32.store align=4 (get_local $unit) (get_local $id))
    (i32.store align=4 (i32.add (get_local $unit) (i32.const 4)) (i32.xor (get_local $id) (i32.const 816191)))
    (get_local $unit))
  (func $verify (param $unit i32)
    (local $@stack_entry i32)
    (set_local $@stack_entry (global.get $@stack))
    (if (i32.ne (i32.load align=4 (i32.add (get_local $unit) (i32.const 4))) (i32.xor (i32.load align=4 (get_local $unit)) (i32.const 816191)))
      (then
  ...
  (func $main (export "main") (result i32)
    ...
    (local $capacity i32)
    (set_local $@stack_entry (global.get $@stack))
    (set_local $actual_offset (i32.add (i32.const 1216) (i32.const 8)))
    (global.set $storage (get_local $actual_offset))
    ...
    (block $@block_1_break
      ...
      (loop $@block_1_continue
        ...
        (if (i32.load align=4 (i32.add (global.get $storage) (i32.mul (get_local $idx) (i32.const 4))))
          (then
            (call $verify (i32.load align=4 (i32.add (global.get $storage) (i32.mul (get_local $idx) (i32.const 4)))))
            (call $free (i32.load align=4 (i32.add (global.get $storage) (i32.mul (get_local $idx) (i32.const 4)))))
            (i32.store align=4 (i32.add (global.get $storage) (i32.mul (get_local $idx) (i32.const 4))) (i32.const 0)))
          (else
            (i32.store align=4 (i32.add (global.get $storage) (i32.mul (get_local $idx) (i32.const 4))) (call $allocate (i32.add (i32.const 1) (get_local $iter))))))
    ...
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.load align=4 (get_local $iter))))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.load align=4 (get_local $idx))))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
