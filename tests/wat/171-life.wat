(module
  ...
  (global $mm_expand_by (mut i32) (i32.const 10))
  ...
  (func $mm_malloc (param $size i32) (result i32)
    ...
    (if (i32.gt_s (get_local $size) (global.get $mm_size))
      (then
        (unreachable)))
    (set_local $unit_size (i32.add (i32.const 1) (i32.mul (i32.const 8) (global.get $mm_size))))
    (if (if (result i32) (i32.ge_s (global.get $mm_first) (i32.const 0)) (then (i32.const 0)) (else (i32.ne (i32.eq (global.get $mm_inuse) (global.get $mm_capacity)) (i32.const 0))))
      (then
        ...
        (set_local $required (i32.add (i32.div_s (i32.add (i32.add (i32.const 2865) (global.get $mm_extra_offset)) (i32.mul (i32.mul (i32.add (global.get $mm_capacity) (global.get $mm_expand_by)) (i32.const 8)) (get_local $unit_size))) (i32.const 64000)) (i32.const 1)))
        ...
        (global.set $mm_capacity (i32.add (global.get $mm_capacity) (global.get $mm_expand_by)))))
      ...
      (then
        ...
        (if (i32.ge_s (global.get $mm_inuse) (global.get $mm_capacity))
          (then
            ...
            (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
            (i64.store (global.get $@stack) (i64.const 122))
            (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
            (call $printf (global.get $@stack) (i32.const 2))
            (unreachable)))
        (i64.store (i32.add (global.get $mm_start) (i32.mul (i32.mul (global.get $mm_inuse) (get_local $unit_size)) (i32.const 8))) (i64.const -1))
        (global.set $mm_first (global.get $mm_inuse))
        (global.set $mm_inuse (i32.add (global.get $mm_inuse) (i32.const 1)))))
    (if (i32.lt_s (global.get $mm_first) (i32.const 0))
      (then
        (i64.store (global.get $@stack) (i64.const 1248))
        (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
        (i64.store (global.get $@stack) (i64.const 128))
        (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
        (call $printf (global.get $@stack) (i32.const 2))
        (unreachable)))
    (set_local $cur (i32.add (global.get $mm_start) (i32.mul (i32.mul (global.get $mm_first) (get_local $unit_size)) (i32.const 8))))
    (if (i64.eq (i64.load (get_local $cur)) (i64.const 0))
      (then
        (i64.store (global.get $@stack) (i64.const 1293))
        (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    ...
    (set_local $result (i32.add (i32.add (get_local $cur) (i32.const 8)) (i32.mul (get_local $j) (global.get $mm_size))))
    (if (i64.eqz (i64.load (get_local $cur)))
      (then
        (loop $@block_1_continue
          (global.set $mm_first (i32.add (global.get $mm_first) (i32.const 1)))
          (br_if $@block_1_continue (if (result i32) (i32.ge_s (global.get $mm_first) (global.get $mm_inuse)) (then (i32.const 0)) (else (i32.ne (i64.eqz (i64.load (i32.add (global.get $mm_start) (i32.mul (i32.mul (global.get $mm_first) (get_local $unit_size)) (i32.const 8))))) (i32.const 0))))))
        (if (i32.eq (global.get $mm_first) (global.get $mm_inuse))
          (then
            (global.set $mm_first (i32.const -1))))))
    (global.set $@stack (get_local $@stack_entry))
    (get_local $result))
  (func $mm_free (param $box i32)
    (local $@stack_entry i32)
    (local $unit_size i32)
    (local $offset i32)
    (local $idx i32)
    ...
    (set_local $cur (i32.add (global.get $mm_start) (i32.mul (i32.mul (get_local $idx) (get_local $unit_size)) (i32.const 8))))
    (set_local $j (i32.div_s (i32.sub (i32.sub (get_local $box) (get_local $cur)) (i32.const 8)) (global.get $mm_size)))
    (if (i32.lt_s (get_local $j) (i32.const 0))
      (then
        (i64.store (global.get $@stack) (i64.const 1334))
        (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
        (i64.store (global.get $@stack) (i64.const 156))
        (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
        (call $printf (global.get $@stack) (i32.const 2))
        (unreachable)))
    (if (i32.ge_s (get_local $j) (i32.const 64))
      (then
        (i64.store (global.get $@stack) (i64.const 1372))
        (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
        (i64.store (global.get $@stack) (i64.const 157))
        (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
        (call $printf (global.get $@stack) (i32.const 2))
        (unreachable)))
    (if (i32.ne (get_local $box) (i32.add (i32.add (get_local $cur) (i32.const 8)) (i32.mul (get_local $j) (global.get $mm_size))))
      (then
        (i64.store (global.get $@stack) (i64.const 1410))
        (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
        (i64.store (global.get $@stack) (i64.const 158))
        (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
        (call $printf (global.get $@stack) (i32.const 2))
        (unreachable)))
    (if (i32.wrap_i64 (i64.and (i64.load (get_local $cur)) (i64.shl (i64.const 1) (i64.extend_i32_s (get_local $j)))))
      (then
        (i64.store (global.get $@stack) (i64.const 1476))
        (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
        (i64.store (global.get $@stack) (i64.const 159))
        (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
        (call $printf (global.get $@stack) (i32.const 2))
        (unreachable)))
    (i64.store (get_local $cur) (i64.xor (i64.load (get_local $cur)) (i64.shl (i64.const 1) (i64.extend_i32_s (get_local $j)))))
  ...
  (func $count_boxes (result i32)
    ...
    (block $@block_1_break
      (loop $@block_1_continue
        ...
        (set_local $res (i32.add (get_local $res) (i32.sub (i32.const 64) (i32.wrap_i64 (i64.popcnt (i64.load (i32.add (global.get $mm_start) (i32.mul (i32.mul (get_local $i) (get_local $unit_size)) (i32.const 8)))))))))
  ...
  (func $mm_stat
    (local $@stack_entry i32)
    (set_local $@stack_entry (global.get $@stack))
    (i64.store (global.get $@stack) (i64.const 1558))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
  ...
  (func $mm_new_box (param $level i32) (param $x0 i32) (param $y0 i32) (result i32)
    ...
    (set_local $box (call $mm_malloc (select (i32.const 216) (i32.const 116) (i32.eqz (get_local $level)))))
            ...
            (block $@block_1_1_break
              ...
              (loop $@block_1_1_continue
                ...
                (if (i32.load (i32.add (i32.add (get_local $box) (i32.const 16)) (i32.mul (i32.add (i32.mul (get_local $y) (i32.const 5)) (get_local $x)) (i32.const 4))))
                  (then
                    (call $mm_release_box (i32.load (i32.add (i32.add (get_local $box) (i32.const 16)) (i32.mul (i32.add (i32.mul (get_local $y) (i32.const 5)) (get_local $x)) (i32.const 4)))))))
                (set_local $x (i32.add (get_local $x) (i32.const 1)))
                (br $@block_1_1_continue)))
            (set_local $y (i32.add (get_local $y) (i32.const 1)))
            (br $@block_1_continue)))))
    (call $mm_free (get_local $box)))
            ...
            (if (get_local $g)
              (then
                (if (i32.ne (i32.load (get_local $g)) (i32.sub (i32.load (get_local $w)) (i32.const 1)))
                  (then
                    (i64.store (global.get $@stack) (i64.const 1587))
                    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
                    (i64.store (global.get $@stack) (i64.const 233))
                    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
                    (call $printf (global.get $@stack) (i32.const 2))
                    (unreachable)))
                (if (i32.ne (i32.load (i32.add (get_local $g) (i32.const 12))) (i32.div_s (i32.load (i32.add (get_local $w) (i32.const 12))) (i32.const 5)))
                  (then
                    (i64.store (global.get $@stack) (i64.const 1643))
                    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
                    (i64.store (global.get $@stack) (i64.const 234))
                    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
                    (call $printf (global.get $@stack) (i32.const 2))
                    (unreachable)))
                (if (i32.ne (i32.load (i32.add (get_local $g) (i32.const 4))) (i32.add (i32.load (i32.add (get_local $w) (i32.const 4))) (i32.mul (i32.load (i32.add (get_local $g) (i32.const 12))) (get_local $x))))
                  (then
                    (i64.store (global.get $@stack) (i64.const 1695))
                    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
                    (i64.store (global.get $@stack) (i64.const 235))
                    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
                    (call $printf (global.get $@stack) (i32.const 2))
                    (unreachable)))
                (if (i32.ne (i32.load (i32.add (get_local $g) (i32.const 8))) (i32.add (i32.load (i32.add (get_local $w) (i32.const 8))) (i32.mul (i32.load (i32.add (get_local $g) (i32.const 12))) (get_local $y))))
                  (then
                    (i64.store (global.get $@stack) (i64.const 1755))
                    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
                    (i64.store (global.get $@stack) (i64.const 236))
                    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
                    (call $printf (global.get $@stack) (i32.const 2))
                    (unreachable)))
  ...
  (func $set_cell (param $x i32) (param $y i32) (param $val i32)
    ...
    (if (get_local $verbose)
      (then
        (i64.store (global.get $@stack) (i64.const 1815))
        (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    ...
    (if (i32.eqz (block $@block_1_break (result i32) (drop (br_if $@block_1_break (i32.const 0) (i32.gt_s (i32.load (i32.add (global.get $world) (i32.const 4))) (get_local $x)))) (drop (br_if $@block_1_break (i32.const 0) (i32.ge_s (get_local $x) (i32.add (i32.load (i32.add (global.get $world) (i32.const 4))) (get_local $size))))) (drop (br_if $@block_1_break (i32.const 0) (i32.gt_s (i32.load (i32.add (global.get $world) (i32.const 8))) (get_local $y)))) (drop (br_if $@block_1_break (i32.const 0) (i32.ge_s (get_local $y) (i32.add (i32.load (i32.add (global.get $world) (i32.const 8))) (get_local $size))))) (i32.const 1)))
      (then
        ...
        (if (get_local $verbose)
          (then
            (i64.store (global.get $@stack) (i64.const 1837))
            (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
            (i64.store (global.get $@stack) (i64.extend_i32_s (get_local $x)))
            (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
            (i64.store (global.get $@stack) (i64.extend_i32_s (get_local $y)))
        ...
        (if (get_local $verbose)
          (then
            (i64.store (global.get $@stack) (i64.const 1887))
            (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
        ...
        (if (get_local $verbose)
          (then
            (i64.store (global.get $@stack) (i64.const 1931))
            (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
          ...
          (loop $@block_3_continue
            ...
            (if (i32.eq (get_local $wsize) (i32.load (i32.add (global.get $world) (i32.const 12))))
              (then
                (if (get_local $verbose)
                  (then
                    (i64.store (global.get $@stack) (i64.const 1964))
                    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
                ...
                (if (i32.ne (i32.add (i32.load (i32.add (get_local $w) (i32.const 4))) (i32.mul (get_local $xp) (get_local $wsize))) (i32.load (i32.add (global.get $world) (i32.const 4))))
                  (then
                    (i64.store (global.get $@stack) (i64.const 2010))
                    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
                    (i64.store (global.get $@stack) (i64.const 322))
                    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
                    (call $printf (global.get $@stack) (i32.const 2))
                    (unreachable)))
                (if (i32.ne (i32.add (i32.load (i32.add (get_local $w) (i32.const 8))) (i32.mul (get_local $yp) (get_local $wsize))) (i32.load (i32.add (global.get $world) (i32.const 8))))
                  (then
                    (i64.store (global.get $@stack) (i64.const 2071))
                    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
                    (i64.store (global.get $@stack) (i64.const 323))
                    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
                    (call $printf (global.get $@stack) (i32.const 2))
                    (unreachable)))
            ...
            (if (get_local $verbose)
              (then
                (i64.store (global.get $@stack) (i64.const 2132))
                (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
                ...
                (global.set $@stack (i32.sub (global.get $@stack) (i32.const 40)))
                (call $printf (global.get $@stack) (i32.const 6))))
            (i32.store (i32.add (i32.add (get_local $w) (i32.const 16)) (i32.mul (i32.add (i32.mul (i32.const 5) (get_local $yp)) (get_local $xp)) (i32.const 4))) (call $mm_new_box (get_local $new_level) (i32.add (i32.load (i32.add (get_local $w) (i32.const 4))) (i32.mul (get_local $xp) (get_local $wsize))) (i32.add (i32.load (i32.add (get_local $w) (i32.const 8))) (i32.mul (get_local $yp) (get_local $wsize)))))
    ...
    (block $@block_4_break
      (loop $@block_4_continue
        (if (get_local $verbose)
          (then
            (i64.store (global.get $@stack) (i64.const 2186))
            (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
            (i64.store (global.get $@stack) (i64.extend_i32_s (get_local $x)))
            (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
            (i64.store (global.get $@stack) (i64.extend_i32_s (get_local $y)))
        ...
        (if (i32.eqz (block $@block_4_1_break (result i32) (drop (br_if $@block_4_1_break (i32.const 0) (i32.gt_s (i32.load (i32.add (get_local $w) (i32.const 4))) (get_local $x)))) (drop (br_if $@block_4_1_break (i32.const 0) (i32.ge_s (get_local $x) (i32.add (i32.load (i32.add (get_local $w) (i32.const 4))) (i32.load (i32.add (get_local $w) (i32.const 12))))))) (drop (br_if $@block_4_1_break (i32.const 0) (i32.gt_s (i32.load (i32.add (get_local $w) (i32.const 8))) (get_local $y)))) (drop (br_if $@block_4_1_break (i32.const 0) (i32.ge_s (get_local $y) (i32.add (i32.load (i32.add (get_local $w) (i32.const 8))) (i32.load (i32.add (get_local $w) (i32.const 12))))))) (i32.const 1)))
          (then
            (i64.store (global.get $@stack) (i64.const 2223))
            (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
            (i64.store (global.get $@stack) (i64.const 343))
            (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
            (call $printf (global.get $@stack) (i32.const 2))
            (unreachable)))
        (if (i32.eqz (i32.load (get_local $w)))
          ...
          (else
            ...
            (if (i32.ne (get_local $t1) (i32.load (get_local $w)))
              (then
                (i64.store (global.get $@stack) (i64.const 2397))
                (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
                (i64.store (global.get $@stack) (i64.const 365))
                (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
                (call $printf (global.get $@stack) (i32.const 2))
                (unreachable)))
            (if (i32.ne (get_local $t2) (i32.load (i32.add (get_local $w) (i32.const 4))))
              (then
                (i64.store (global.get $@stack) (i64.const 2443))
                (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
                (i64.store (global.get $@stack) (i64.const 366))
                (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
                (call $printf (global.get $@stack) (i32.const 2))
                (unreachable)))
            (if (i32.ne (get_local $t3) (i32.load (i32.add (get_local $w) (i32.const 8))))
              (then
                (i64.store (global.get $@stack) (i64.const 2486))
                (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
                (i64.store (global.get $@stack) (i64.const 367))
                (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
                (call $printf (global.get $@stack) (i32.const 2))
                (unreachable)))
            (if (i32.ne (get_local $size) (i32.load (i32.add (get_local $w) (i32.const 12))))
              (then
                (i64.store (global.get $@stack) (i64.const 2529))
                (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
                (i64.store (global.get $@stack) (i64.const 368))
                (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
                (call $printf (global.get $@stack) (i32.const 2))
                (unreachable)))))
        (br $@block_4_continue)))
    (if (get_local $verbose)
      (then
        (i64.store (global.get $@stack) (i64.const 2576))
  ...
  (func $get_cell (param $x i32) (param $y i32) (result i32)
    ...
    (loop $@block_2_continue
      (if (get_local $verbose)
        (then
          (i64.store (global.get $@stack) (i64.const 2583))
          (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
          (i64.store (global.get $@stack) (i64.extend_i32_s (get_local $x)))
          (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
          (i64.store (global.get $@stack) (i64.extend_i32_s (get_local $y)))
      ...
      (if (i32.eqz (i32.load (get_local $w)))
        (then
          ...
          (if (get_local $verbose)
            (then
              (i64.store (global.get $@stack) (i64.const 2626))
              (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
              (i64.store (global.get $@stack) (i64.extend_i32_s (i32.load (get_local $w))))
              (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
              (i64.store (global.get $@stack) (i64.extend_i32_s (i32.load (i32.add (get_local $w) (i32.const 4)))))
  ...
  (func $dump_cells0 (param $w i32) (param $verbose i32)
    ...
    (if (get_local $verbose)
      (then
        (i64.store (global.get $@stack) (i64.const 2660))
        (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
        (i64.store (global.get $@stack) (i64.extend_i32_s (i32.load (get_local $w))))
        (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
        (i64.store (global.get $@stack) (i64.extend_i32_s (i32.load (i32.add (get_local $w) (i32.const 4)))))
        ...
        (block $@block_1_1_break
          ...
          (loop $@block_1_1_continue
            ...
            (if (i32.load8_s (i32.add (i32.add (get_local $w) (i32.const 16)) (i32.add (i32.mul (get_local $y) (i32.const 10)) (get_local $x))))
              (then
                (i64.store (global.get $@stack) (i64.const 2672))
                (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    ...
    (if (get_local $verbose)
      (then
        (i64.store (global.get $@stack) (i64.const 2681))
        (global.set $@stack (i32.sub (global.get $@stack) (i32.const 0)))
        (call $printf (global.get $@stack) (i32.const 1))))
    (global.set $@stack (get_local $@stack_entry)))
          ...
          (loop $@block_1_1_continue
            ...
            (if (i32.load (i32.add (i32.add (get_local $w) (i32.const 16)) (i32.mul (i32.add (i32.mul (get_local $y) (i32.const 5)) (get_local $x)) (i32.const 4))))
              ...
              (else
                (if (get_local $verbose)
                  (then
                    (i64.store (global.get $@stack) (i64.const 2683))
                    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 0)))
                    (call $printf (global.get $@stack) (i32.const 1))))))
            (set_local $x (i32.add (get_local $x) (i32.const 1)))
            (br $@block_1_1_continue)))
  ...
  (func $dump_all (param $verbose i32)
    ...
    (i64.store (global.get $@stack) (i64.const 2685))
    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 0)))
    (call $printf (global.get $@stack) (i32.const 1))
    (global.set $@stack (get_local $@stack_entry)))
            ...
            (if (i32.load8_s (i32.add (i32.add (get_local $w) (i32.const 16)) (i32.add (i32.mul (get_local $y) (i32.const 10)) (get_local $x))))
              (then
                (if (i32.ge_s (i32.load (get_local $k)) (get_local $n))
                  (then
                    (i64.store (global.get $@stack) (i64.const 2687))
                    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
                    (i64.store (global.get $@stack) (i64.const 582))
                    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
                    (call $printf (global.get $@stack) (i32.const 2))
                    (unreachable)))
  ...
  (func $test_1
    ...
    (i64.store (global.get $@stack) (i64.const 2725))
    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 0)))
    (call $printf (global.get $@stack) (i32.const 1))
    (block $@block_3_break
      (set_local $i (i32.const 0))
    ...
    (i64.store (global.get $@stack) (i64.const 2737))
    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 0)))
    (call $printf (global.get $@stack) (i32.const 1))
    (block $@block_4_break
      (set_local $i (i32.const 0))
    ...
    (call $sort_points (get_local $n_pts) (get_local $pts))
    (i64.store (global.get $@stack) (i64.const 2750))
    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 0)))
    (call $printf (global.get $@stack) (i32.const 1))
    (block $@block_5_break
      (set_local $i (i32.const 0))
      (loop $@block_5_continue
        ...
        (set_local $i (i32.add (get_local $i) (i32.const 1)))
        (br $@block_5_continue)))
    (i64.store (global.get $@stack) (i64.const 2763))
    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 0)))
    (call $printf (global.get $@stack) (i32.const 1))
  ...
  (func $test_2
    ...
    (block $@block_2_break
      ...
      (loop $@block_2_continue
        ...
        (block $@block_2_1_break
          ...
          (loop $@block_2_1_continue
            ...
            (if (i32.ne (call $get_cell (get_local $x) (get_local $y)) (f64.lt (call $mulberry32) (get_local $density)))
              (then
                (i64.store (global.get $@stack) (i64.const 2776))
                (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
                (i64.store (global.get $@stack) (i64.const 691))
                (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
                (call $printf (global.get $@stack) (i32.const 2))
                (unreachable)))
            (set_local $x (i32.add (get_local $x) (i32.const 1)))
        ...
        (set_local $y (i32.add (get_local $y) (i32.const 1)))
        (br $@block_2_continue)))
    (i64.store (global.get $@stack) (i64.const 2847))
    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 0)))
    (call $printf (global.get $@stack) (i32.const 1))
    (global.set $@stack (get_local $@stack_entry)))
  (func $main (export "main") (result i32)
    ...
    (block $@block_1_break
      ...
      (loop $@block_1_continue
        ...
        (i64.store (global.get $@stack) (i64.const 2851))
        (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
