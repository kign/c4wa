(module
  ...
  (func $v2
    (local $p i32)
    (local $d i32)
    (i64.store (i32.const 24) (i64.extend_i32_s (i32.const 1024)))
    ...
    (block $@block_1_break
      ...
      (loop $@block_1_continue
        ...
        (if (i32.gt_s (i32.mul (get_local $d) (get_local $d)) (get_local $p))
          (then
            (i64.store (i32.const 32) (i64.extend_i32_s (i32.const 1026)))
            (i64.store (i32.const 40) (i64.extend_i32_s (get_local $p)))
            (call $printf (i32.const 32) (i32.const 2))))
        (set_local $p (i32.add (get_local $p) (i32.const 2)))
        (br $@block_1_continue)))
    (i64.store (i32.const 24) (i64.extend_i32_s (i32.const 1030)))
    (call $printf (i32.const 24) (i32.const 1)))
  (func $v3
    (local $p i32)
    (i64.store (i32.const 48) (i64.extend_i32_s (i32.const 1024)))
    ...
    (block $@block_1_break
      ...
      (loop $@block_1_continue
        ...
        (if (call $test (get_local $p))
          (then
            (i64.store (i32.const 56) (i64.extend_i32_s (i32.const 1026)))
            (i64.store (i32.const 64) (i64.extend_i32_s (get_local $p)))
            (call $printf (i32.const 56) (i32.const 2))))
        (set_local $p (i32.add (get_local $p) (i32.const 2)))
        (br $@block_1_continue)))
    (i64.store (i32.const 48) (i64.extend_i32_s (i32.const 1030)))
    (call $printf (i32.const 48) (i32.const 1)))
