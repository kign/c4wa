  ...
  (func $read (param $X i32) (param $Y i32) (param $pos i32) (param $init i32)
    ...
    (block $@block_1_break
      (loop $@block_1_continue
        ...
        (i32.store8 align=1 (i32.add (get_local $pos) (get_local $i)) (select (i32.const 1) (i32.const 0) (i32.eq (i32.load8_s align=1 (i32.add (get_local $init) (get_local $i))) (i32.const 120))))
      ...
      (loop $@block_1_continue
        ...
        (block $@block_1_1_break
          ...
          (loop $@block_1_1_continue
            ...
            (call $printf (select (i32.const 1024) (select (i32.const 1026) (i32.const 1028) (i32.and (i32.eq (get_local $val) (i32.const 2)) (get_local $dbg))) (i32.eq (get_local $val) (i32.const 1))) (global.get $@stack))
