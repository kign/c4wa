        ...
        (block $@block_1_2_break
          ...
          (loop $@block_1_2_continue
            (br_if $@block_1_2_break (i32.eqz (block $@block_1_1_break (result i32)
              (drop (br_if $@block_1_1_break (i32.const 0) (i32.eqz (i32.lt_s (get_local $i) (get_local $n)))))
              (drop (br_if $@block_1_1_break (i32.const 0) (i32.eqz (i32.lt_s (i32.mul (i32.load (i32.add (get_local $primes) (i32.mul (get_local $i) (i32.const 4)))) (i32.load (i32.add (get_local $primes) (i32.mul (get_local $i) (i32.const 4))))) (get_local $p)))))
              (drop (br_if $@block_1_1_break (i32.const 0) (i32.eqz (i32.ne (i32.rem_s (get_local $p) (i32.load (i32.add (get_local $primes) (i32.mul (get_local $i) (i32.const 4))))) (i32.const 0)))))
              (i32.const 1))))
    ...
    (block $@block_1_break
      ...
      (loop $@block_1_continue
        ...
        (if (block $@block_1_2_break (result i32)
            (drop (br_if $@block_1_2_break (i32.const 0) (i32.eqz (i32.gt_s (get_local $d) (i32.const 0)))))
            (drop (br_if $@block_1_2_break (i32.const 0) (i32.eqz (i32.lt_s (get_local $d) (get_local $p)))))
            (drop (br_if $@block_1_2_break (i32.const 0) (i32.eqz (i32.eqz (i32.rem_s (get_local $p) (get_local $d))))))
            (i32.const 1))
          (then
            (set_local $p (i32.add (get_local $p) (i32.const 2)))
            (br $@block_1_continue)))
