(module
  ...
  (func $gen1 (param $primes i32) (result i32)
    ...
    (local $n i32)
    (local $p i32)
    (i32.store align=4 (get_local $primes) (i32.const 2))
      ...
      (loop $@block_1_continue
        ...
        (block $@block_1_1_break
          ...
          (loop $@block_1_1_continue
            (br_if $@block_1_1_break (i32.eqz (block $@block_1_1_1_break (result i32) (drop (br_if $@block_1_1_1_break (i32.const 0) (i32.ge_s (get_local $i) (get_local $n)))) (drop (br_if $@block_1_1_1_break (i32.const 0) (i32.ge_s (i32.mul (i32.load align=4 (i32.add (get_local $primes) (i32.mul (get_local $i) (i32.const 4)))) (i32.load align=4 (i32.add (get_local $primes) (i32.mul (get_local $i) (i32.const 4))))) (get_local $p)))) (drop (br_if $@block_1_1_1_break (i32.const 0) (i32.eq (i32.rem_s (get_local $p) (i32.load align=4 (i32.add (get_local $primes) (i32.mul (get_local $i) (i32.const 4))))) (i32.const 0)))) (i32.const 1))))
            (set_local $i (i32.add (get_local $i) (i32.const 1)))
            (br $@block_1_1_continue)))
        (if (if (result i32) (i32.ge_s (get_local $i) (get_local $n)) (then (i32.const 1)) (else (i32.ne (i32.ne (i32.rem_s (get_local $p) (i32.load align=4 (i32.add (get_local $primes) (i32.mul (get_local $i) (i32.const 4))))) (i32.const 0)) (i32.const 0))))
          (then
            (i32.store align=4 (i32.add (get_local $primes) (i32.mul (get_local $n) (i32.const 4))) (get_local $p))
      ...
      (loop $@block_1_continue
        ...
        (block $@block_1_1_break
          ...
          (loop $@block_1_1_continue
            ...
            (set_local $d (i32.load align=4 (i32.add (get_local $primes) (i32.mul (get_local $i) (i32.const 4)))))
      ...
      (loop $@block_1_continue
        ...
        (block $@block_1_1_break
          ...
          (loop $@block_1_1_continue
            ...
            (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.load align=4 (i32.add (get_local $primes) (i32.mul (get_local $i) (i32.const 4))))))
            (call $printf (i32.const 1024) (global.get $@stack))
            (set_local $i (i32.add (get_local $i) (i32.const 1)))
            (br $@block_1_1_continue)))
        (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.load align=4 (i32.add (get_local $primes) (i32.mul (i32.sub (get_local $n) (i32.const 1)) (i32.const 4))))))
