(module
  ...
  (func $get_cell (param $x i32) (param $y i32) (param $plane i32) (result i32)
    ...
    (global.set $@stack (get_local $@stack_entry))
    (i32.const 0))
  (func $life_fin_prepare (param $cells i32) (param $X i32) (param $Y i32)
    (local $cnt i32)
    (local $hash i32)
    (local $y i32)
    (local $x i32)
    ...
    (block $@block_1_break
      (loop $@block_1_continue
        ...
        (br $@block_1_continue))))
  (func $life_fin_step (param $cells i32) (param $cellsnew i32) (param $X i32) (param $Y i32)
    (local $ind i32)
    (local $x i32)
    (local $y i32)
    (local $n i32)
  ...
  (func $life_fin_read (param $pos i32) (param $X i32) (param $Y i32) (param $x0 i32) (param $y0 i32) (param $src i32) (param $sX i32) (param $sY i32)
    ...
    (block $@block_1_break
      (loop $@block_1_continue
        ...
        (set_local $y (i32.add (get_local $y) (i32.const 1)))
        (br $@block_1_continue))))
  (func $life_prepare_box (param $w i32)
    (local $@stack_entry i32)
    (local $idx i32)
    (local $y i32)
    (local $x i32)
    ...
    (if (i32.eqz (get_local $w))
      (then
        ...
        (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
        (i64.store (global.get $@stack) (i64.const 419))
        (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
        (call $printf (global.get $@stack) (i32.const 2))
        (unreachable)))
        ...
        (block $@block_2_1_break
          ...
          (loop $@block_2_1_continue
            ...
            (if (i32.load (i32.add (i32.add (get_local $w) (i32.const 16)) (i32.mul (get_local $idx) (i32.const 4))))
              (then
                (call $life_prepare_box (i32.load (i32.add (i32.add (get_local $w) (i32.const 16)) (i32.mul (get_local $idx) (i32.const 4)))))))
      ...
      (else
        (block $@block_3_1_break
          ...
          (loop $@block_3_1_continue
            (br_if $@block_3_1_break (i32.ge_s (get_local $idx) (i32.const 25)))
            (if (i32.eq (i32.load8_s (i32.add (i32.add (get_local $w) (i32.const 16)) (get_local $idx))) (i32.const 1))
              (then
                (set_local $y (i32.div_s (get_local $idx) (i32.const 5)))
                (set_local $x (i32.rem_s (get_local $idx) (i32.const 5)))
                (block $@block_3_1_1_1_break
                  (set_local $j (i32.const 0))
                  (loop $@block_3_1_1_1_continue
                    (br_if $@block_3_1_1_1_break (i32.ge_s (get_local $j) (i32.const 9)))
                    (if (i32.eq (get_local $j) (i32.const 4))
                      (then
                        (set_local $j (i32.add (get_local $j) (i32.const 1)))
                        (br $@block_3_1_1_1_continue)))
                    ...
                    (if (block $@block_3_1_1_1_1_break (result i32) (drop (br_if $@block_3_1_1_1_1_break (i32.const 0) (i32.gt_s (i32.const 0) (get_local $vx)))) (drop (br_if $@block_3_1_1_1_1_break (i32.const 0) (i32.ge_s (get_local $vx) (i32.const 5)))) (drop (br_if $@block_3_1_1_1_1_break (i32.const 0) (i32.gt_s (i32.const 0) (get_local $vy)))) (drop (br_if $@block_3_1_1_1_1_break (i32.const 0) (i32.ge_s (get_local $vy) (i32.const 5)))) (i32.const 1))
                      (then
    ...
    (global.set $@stack (get_local $@stack_entry)))
  (func $life_step_box (param $w i32) (param $dst i32)
    (local $@stack_entry i32)
    (local $idx i32)
    (local $end i32)
    (local $p i32)
      ...
      (then
        (block $@block_2_1_break
          ...
          (loop $@block_2_1_continue
            ...
            (if (i32.load (i32.add (i32.add (get_local $w) (i32.const 16)) (i32.mul (get_local $idx) (i32.const 4))))
              (then
                (call $life_step_box (i32.load (i32.add (i32.add (get_local $w) (i32.const 16)) (i32.mul (get_local $idx) (i32.const 4)))) (get_local $dst))))
            (set_local $idx (i32.add (get_local $idx) (i32.const 1)))
            (br $@block_2_1_continue))))
      (else
        (set_local $idx (i32.add (i32.add (get_local $w) (i32.const 16)) (i32.mul (i32.const 25) (i32.sub (i32.const 1) (get_local $dst)))))
          ...
          (loop $@block_3_1_continue
            ...
            (if (i32.eqz (i32.load8_s (get_local $p)))
              (then
                (set_local $p (i32.add (get_local $p) (i32.const 1)))
                (br $@block_3_1_continue)))
            (set_local $idx@block_3_1 (i32.sub (get_local $p) (get_local $idx)))
  ...
  (func $life_clean_plane (param $w i32) (param $dst i32)
    ...
    (if (i32.eqz (get_local $w))
      (then
        (i64.store (global.get $@stack) (i64.const 2116))
        (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
        (i64.store (global.get $@stack) (i64.const 494))
        (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
        (call $printf (global.get $@stack) (i32.const 2))
        (unreachable)))
    (if (i32.gt_s (i32.load (get_local $w)) (i32.const 0))
  ...
  (func $life_prepare
    (if (global.get $world)
      (then
        (call $life_prepare_box (global.get $world)))))
  (func $life_step (param $dst i32)
    (if (global.get $world)
      (then
        (call $life_clean_plane (global.get $world) (get_local $dst))
        (call $life_step_box (global.get $world) (get_local $dst)))))
  ...
  (func $main (export "main") (result i32)
    ...
    (set_local $Y (i32.const 20))
    (set_local $pos_0 (i32.const 2392))
    (set_local $pos_1 (i32.add (i32.const 2392) (i32.add (i32.mul (get_local $X) (get_local $Y)) (i32.const 1))))
    ...
    (if (i32.ne (i32.mul (get_local $sX) (get_local $sY)) (call $strlen (get_local $initial_pos)))
      (then
        ...
        (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
        (i64.store (global.get $@stack) (i64.const 575))
        (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
        (call $printf (global.get $@stack) (i32.const 2))
        (unreachable)))
    ...
    (block $@block_2_break
      ...
      (loop $@block_2_continue
          ...
          (loop $@block_2_1_continue
            ...
            (if (i32.ne (call $get_cell (get_local $x) (get_local $y) (i32.const 0)) (i32.load8_s (i32.add (get_local $pos_0) (i32.add (i32.mul (get_local $y) (get_local $X)) (get_local $x)))))
              (then
                ...
                (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
                (i64.store (global.get $@stack) (i64.const 581))
                (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
                (call $printf (global.get $@stack) (i32.const 2))
                (unreachable)))
            (set_local $y (i32.add (get_local $y) (i32.const 1)))
        ...
        (set_local $x (i32.add (get_local $x) (i32.const 1)))
        (br $@block_2_continue)))
    (call $life_fin_prepare (get_local $pos_0) (get_local $X) (get_local $Y))
    (call $life_fin_step (get_local $pos_0) (get_local $pos_1) (get_local $X) (get_local $Y))
    (call $life_prepare)
    (call $life_step (i32.const 1))
    (block $@block_3_break
      (set_local $x (i32.const 0))
      (loop $@block_3_continue
        (br_if $@block_3_break (i32.ge_s (get_local $x) (get_local $X)))
        (block $@block_3_1_break
          (set_local $y (i32.const 0))
          (loop $@block_3_1_continue
            (br_if $@block_3_1_break (i32.ge_s (get_local $y) (get_local $Y)))
            (if (i32.ne (call $get_cell (get_local $x) (get_local $y) (i32.const 1)) (i32.load8_s (i32.add (get_local $pos_1) (i32.add (i32.mul (get_local $y) (get_local $X)) (get_local $x)))))
              (then
                (i64.store (global.get $@stack) (i64.const 2322))
                (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
                (i64.store (global.get $@stack) (i64.const 591))
                (global.set $@stack (i32.sub (global.get $@stack) (i32.const 8)))
                (call $printf (global.get $@stack) (i32.const 2))
                (unreachable)))
            (set_local $y (i32.add (get_local $y) (i32.const 1)))
        ...
        (set_local $x (i32.add (get_local $x) (i32.const 1)))
        (br $@block_3_continue)))
    (i64.store (global.get $@stack) (i64.const 2387))
    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 0)))
    (call $printf (global.get $@stack) (i32.const 1))
    (global.set $@stack (get_local $@stack_entry))
    (i32.const 0))
  (func $mm_init (param $extra_offset i32) (param $size i32)
    ...
    (global.set $__mm_start (i32.add (i32.const 2392) (global.get $__mm_extra_offset))))
  (func $malloc (param $size i32) (result i32)
    ...
    (if (if (result i32) (i32.ge_s (global.get $__mm_first) (i32.const 0)) (then (i32.const 0)) (else (i32.ne (i32.eq (global.get $__mm_inuse) (global.get $__mm_capacity)) (i32.const 0))))
      (then
        (set_local $required (i32.add (i32.div_s (i32.add (i32.add (i32.const 2392) (global.get $__mm_extra_offset)) (i32.mul (i32.mul (i32.add (global.get $__mm_capacity) (global.get $__mm_expand_by)) (i32.const 8)) (get_local $unit_size))) (i32.const 64000)) (i32.const 1)))
