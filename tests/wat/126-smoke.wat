(module
  ...
  (func $force_stack_var (param $x i32)
    ...
    (i64.store align=8 (global.get $@stack) (i64.load align=8 (get_local $x)))
  ...
  (func $test_2
    ...
    (loop $@block_2_continue
      ...
      (i64.store align=8 (get_local $b) (i64.const 11))
      (call $force_stack_var (get_local $b))
      (i64.store align=8 (get_local $b) (i64.mul (i64.load align=8 (get_local $b)) (i64.const 4)))
      (i64.store align=8 (global.get $@stack) (i64.load align=8 (get_local $b)))
      (call $printf (i32.const 1046) (global.get $@stack)))
    (global.set $@stack (get_local $@stack_entry)))
  (func $test_3
    (local $@stack_entry i32)
  ...
  (func $main (export "main") (result i32)
    ...
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (get_local $i@block_3)))
