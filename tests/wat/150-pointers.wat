(module
  ...
  (func $main (export "main") (result i32)
    ...
    (i32.store align=4 (get_local $a) (i32.const 15))
    (set_local $b (i32.add (get_local $a) (i32.const 4)))
    (i32.store align=4 (get_local $b) (i32.const 13))
    (i32.store align=4 (i32.add (get_local $a) (i32.const 8)) (i32.const 11))
    (i32.store align=4 (i32.add (get_local $a) (i32.const 12)) (i32.mul (i32.mul (i32.load align=4 (get_local $a)) (i32.load align=4 (get_local $b))) (i32.load align=4 (i32.add (get_local $a) (i32.const 8)))))
    ...
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.load align=4 (i32.add (get_local $a) (i32.const 8)))))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.load align=4 (i32.add (get_local $a) (i32.const 12)))))
