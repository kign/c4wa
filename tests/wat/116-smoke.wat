(module
  ...
  (func $main (export "main") (result i32)
    ...
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (get_local $increase_by)))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.sub (memory.size) (get_local $initial_size))))
