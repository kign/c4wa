(module
  ...
  (func $test2_int (param $a i32) (param $b i32)
    ...
    (i64.store (global.get $@stack) (i64.const 1061))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (i64.extend_i32_s (get_local $a)))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (i64.extend_i32_s (get_local $b)))
  ...
  (func $test2_long (param $a i64) (param $b i64)
    ...
    (i64.store (global.get $@stack) (i64.const 1106))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (get_local $a))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (get_local $b))
...
(i32.const 1)))
    (i64.store (global.get $@stack) (i64.const 1131))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (i64.extend_i32_s (get_local $a)))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (i64.extend_i32_s (get_local $b)))
...
(i32.const 0)))
    (i64.store (global.get $@stack) (i64.const 1157))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (i64.extend_i32_s (get_local $a)))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (i64.extend_i32_s (get_local $b)))
...
(i32.const 1)))
    (i64.store (global.get $@stack) (i64.const 1183))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (get_local $a))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (get_local $b))
...
(i32.const 0)))
    (i64.store (global.get $@stack) (i64.const 1214))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (get_local $a))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store (global.get $@stack) (get_local $b))
  ...
  (func $main (export "main") (result i32)
    ...
    (local $c i32)
    (set_local $@stack_entry (global.get $@stack))
    (i64.store (global.get $@stack) (i64.const 1245))
    ...
    (set_local $b (i32.const 0))
    (call $test2 (get_local $a) (get_local $b))
    (i64.store (global.get $@stack) (i64.const 1274))
    (global.set $@stack (i32.sub (global.get $@stack) (i32.const 0)))
    (call $printf (global.get $@stack) (i32.const 1))
    (set_local $a (i32.const 0))
    (set_local $b (i32.const 0))
