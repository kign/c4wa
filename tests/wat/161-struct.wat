(module
  ...
  (func $makeStudent (param $name i32) (param $p_res i32) (result i32)
    ...
    (i32.store align=4 (i32.add (get_local $res) (i32.const 4)) (get_local $name))
    (i32.store align=4 (get_local $res) (i32.const 11))
    (i32.store align=4 (get_local $p_res) (get_local $res))
    (global.set $@stack (get_local $@stack_entry))
    (get_local $res))
  (func $print_student (param $student i32)
    (local $@stack_entry i32)
    (set_local $@stack_entry (global.get $@stack))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.load align=4 (i32.add (get_local $student) (i32.const 4)))))
    (global.set $@stack (i32.add (global.get $@stack) (i32.const 8)))
    (i64.store align=8 (global.get $@stack) (i64.extend_i32_s (i32.load align=4 (get_local $student))))
  ...
  (func $main (export "main") (result i32)
    ...
    (i32.store align=4 (get_local $@temp_i32) (i32.mul (i32.load align=4 (get_local $@temp_i32)) (i32.const 2)))
    (set_local $student (i32.load align=4 (get_local $p_student)))
    (call $print_student (get_local $student))
    (i32.store align=4 (get_local $student) (i32.sub (i32.load align=4 (get_local $student)) (i32.const 1)))
    (call $print_student (i32.load align=4 (get_local $p_student)))
    (i32.const 0))
