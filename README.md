...
First command will run all units tests; **this only verifies successful compilation, not correct execution**.
...
making:
  ...
  1. Changes which are NOT expected to change any of the existing WAT files. For example, you could 
...
If there are changed, you should first compare new versions of updated WAT files to approve the changed.
...
if they haven't, you are all set. If they did change, and were expected to, you need to pay attention
